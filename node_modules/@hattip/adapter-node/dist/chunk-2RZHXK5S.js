...
function createRequestAdapter(options = {}) {
  ...
  return function requestAdapter(req) {
    ...
    const ip = req.ip || trustProxy && parseForwardedHeader("for") || ((_a = req.socket) == null ? void 0 : _a.remoteAddress) || "";
    const protocol = protocolOverride || req.protocol || trustProxy && parseForwardedHeader("proto") || ((_b = req.socket) == null ? void 0 : _b.encrypted) && "https" || "http";
