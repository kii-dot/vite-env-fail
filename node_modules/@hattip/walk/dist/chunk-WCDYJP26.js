...
async function createFileMapModule(dir, options) {
...
async function createFileList(dir, options) {
  const files = await walk(dir, options);
  if ((options == null ? void 0 : options.etag) === false) {
...
async function createFileListModule(dir, options) {
...
async function createCompressedFileListModule(dir, options) {
  const files = await createFileList(dir, options);
